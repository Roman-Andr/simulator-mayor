...
- !❌Добавить огланичение по времени на строительво фриланс заказа
...
- !❌Када сторишь ручками из блока иногда выпадает +0 репутации
- !❌Перенести glow place для отдачи блоков рабочим в другое место
- ❌Сделтать confirmation для выхода из фриланса
